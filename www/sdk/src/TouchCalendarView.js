 ...
 */
 ...
 Ext.define("Ext.TouchCalendarView", {
	...
	constructor: function(config){
         ...
         * @param {Ext.TouchCalendarView} this
	 ...
	 */
	initModel: function(){
		if(!Ext.ModelManager.isRegistered('TouchCalendarViewModel')) // TODO: Throws an error in opening Ext.TouchCalendar.html example?? 
		{
	...
	applyViewMode: function(viewMode){
        ...
        var viewModeFns = Ext.TouchCalendarView[viewMode.toUpperCase()];
	...
	statics: {
		...
		MONTH: {
            ...
            getStartDate: function(date){
                return Ext.bind(Ext.TouchCalendarView.WEEK.getStartDate, this)(new Date(date.getFullYear(), date.getMonth(), 1));
            },
